...
<h2 class="text-center">Appointment Details</h2>
	...
	<c:forEach var="apo" items="${apoid}">
		...
		<c:set var="description" value="${apo.description}"/>
	...
	<a href="${appointmentUpdate}">
		<input type="button" name="update" class="btn btn-primary" id="update" value="Change Details">
	</a>
	</td>
	<td>
	<form action="deleteappointmentServlet" method="post" >
		<input type="hidden" value="${apo.cid}" name="cid">
		<button type="submit" value="${apo.apoid}" name="submit" class="btn btn-danger" onclick="check()">Delete Details</button>
	</form>
	</td>
	</tr>
		</table>
...
<a href="${app}" >
  <button type="button" class="btn btn-info" style="height:50px;width:20%;" name="id">Home</button>
</a>
</div>
