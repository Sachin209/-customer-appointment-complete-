...
<center> <input type=button id="update" name="id" style="height:50px; width:30%; border-radius:10px;" class="btn btn-info " value="Make an Appointment"></a>	

	 <form action="confirmidServlet" method="post">
	<button type="submit" id="update" name="Submit" style="height:50px; width:30%; border-radius:10px;" value="<%=id%>" class="btn btn-info">Previous Appointments</button>
	</form>
