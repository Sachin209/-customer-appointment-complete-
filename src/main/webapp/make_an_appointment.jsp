  ...
  <nav class="navbar navbar-expand-md py-4 navbar-dark red  sticky-top  ">
      ...
      <div class="collapse navbar-collapse   ">
          <ul class="navbar-nav mr-auto  ">
              <li class="nav-item"><a href="Home.jsp" class="nav-link h5 mr-2  " style="font-family: 'Raleway', sans-serif;" id="item" ><i class="bi bi-house pr-2"></i><b>Home</b>  </a></li>
              <li class="nav-item"><a href="customerLogin.jsp" class="nav-link h5 mr-2"id="item" style="font-family: 'Raleway', sans-serif;"> <i class="bi bi-info-circle pr-2"></i></i><b>Login</b> </a></li>
          </ul>
      </div>
...
%>
    ...
    <form  action="Appointmentinsert" method="post" class="mt-5">
      ...
      <div class="form-group row">
        <label for="" class="col-sm-2 col-form-label">Your Customer ID</label>
        <div class="col-sm-10">
 	  <input type = "text" class="form-control" id="cid" name = "cid" value="<%= id %>" style="width:57%;" readonly>
        </div>
      </div>


      <div class="form-group row">
        <label for="" class="col-sm-2 col-form-label">Repair Services</label>
        <div class="col-sm-10">
          <select id="type" name="type" style="width:57%;" class="form-control" required>
 	...
 	<select id="type" name="time" style="width:57%;" class="form-control" required>
		<option selected></option>
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-10">
 	  <input type="date" id="date" style="width:57%;" name="date" class="form-control" required><br><br>
        </div>
      </div>
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-10">
      <textarea id="type" name="des" style="width:57%;" class="form-control" required></textarea>
        </div>
      </div>
...
<div class="text-center">
	<input type="submit" class="btn btn-success mt-5" style="height:50px;width:20%;" name="Submit" id="submit" value="Confirm">
</div>
